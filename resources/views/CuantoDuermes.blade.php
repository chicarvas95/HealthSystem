...
<body>
    ...
    <div class="container">
        ...
        <div class="text-left">
            <b><a href="/haces-ejercicio"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-caret-left-fill" viewBox="0 0 16 16">
    ...
    <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
        ...
        <h6 class="display-4">Cuanto duermes? </h6>
